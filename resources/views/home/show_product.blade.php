    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <div class="product-slider flexslider">
            <ul class="slides">
              <li data-thumb="assets/images/shop/single-product-01.jpg"> <img src="assets/images/shop/single-product-01.jpg" class="img-responsive" alt="single-product" /> </li>
              <li data-thumb="assets/images/shop/single-product-02.jpg"> <img src="assets/images/shop/single-product-02.jpg" class="img-responsive" alt="single-product" /> </li>
              <li data-thumb="assets/images/shop/single-product-03.jpg"> <img src="assets/images/shop/single-product-03.jpg" class="img-responsive" alt="single-product" /> </li>
              <li data-thumb="assets/images/shop/single-product-04.jpg"> <img src="assets/images/shop/single-product-04.jpg" class="img-responsive" alt="single-product" /> </li>
            </ul>
          </div>
        </div>
        <div class="col-md-6">
          ...
          <div class="single-product-qty">
            <form>
              ...
              <span class="input-group-btn"><a href="#" class="btn btn-dark">ADD TO CART <i class="icofont icofont-cart"></i></a></span>
            </form>
          </div>
      ...
      <div class="row mt-50">
        <div class="col-md-3 col-sm-6">
          <div class="product">
            <div class="product-wrap"> <img src="assets/images/shop/product-01.jpg" class="img-responsive" alt="team-01">
        ...
        <div class="col-md-3 col-sm-6">
          <div class="product">
            <div class="product-wrap"> <img src="assets/images/shop/product-02.jpg" class="img-responsive" alt="team-01">
              <div class="product-caption">
                <div class="product-description text-center">
                  <div class="product-description-wrap">
                    <div class="product-title"> <a href="#" class="btn btn-color btn-circle">ADD TO CART <span class="icon"><i class="mdi mdi-cart"></i></span></a> </div>
        ...
        <div class="col-md-3 col-sm-6">
          <div class="product">
            <div class="product-wrap"> <img src="assets/images/shop/product-03.jpg" class="img-responsive" alt="team-01">
              <div class="product-caption">
                <div class="product-description text-center">
                  <div class="product-description-wrap">
                    <div class="product-title"> <a href="#" class="btn btn-color btn-circle">ADD TO CART <span class="icon"><i class="mdi mdi-cart"></i></span></a> </div>
        ...
        <div class="col-md-3 col-sm-6">
          <div class="product">
            <div class="product-wrap"> <img src="assets/images/shop/product-04.jpg" class="img-responsive" alt="team-01">
              <div class="product-caption">
                <div class="product-description text-center">
                  <div class="product-description-wrap">
                    <div class="product-title"> <a href="#" class="btn btn-color btn-circle">ADD TO CART <span class="icon"><i class="mdi mdi-cart"></i></span></a> </div>
