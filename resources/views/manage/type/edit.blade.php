								...
								<div class="tab-pane active" id="tab_0">
									<div class="portlet box green">
										...
										<div class="portlet-body form">
											<!-- BEGIN FORM-->
											<form action="/manage/type/store" class="form-horizontal" method="post">
											{{ csrf_field() }}
												...
												<div class="form-body">
													<div class="form-group">
														...
														<div class="col-md-8">
															<select class="form-control" name="typeid">
																<option value="" {{$type->pid == 0 ? 'selected':''}}>≡ 作为一级栏目 ≡</option>
																@foreach($group as $k=>$vo)
																<option value="{{$vo->id}}.{{$vo->path}}" {{$type->pid == $vo->id ? 'selected':''}}>{!! $nbsp[$k] !!}{{$vo->name}}</option>
																@endforeach
															</select>
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-md-8">
															<input type="text" class="form-control input-circle" value="{{$type->name}}" required="" name="name" required>
														</div>
													</div>
													<div class="form-group">
														<label class="col-md-2 control-label">英文名称</label>
														<div class="col-md-8">
															<input type="text" class="form-control input-circle" value="{{$type->english}}" name="ename" required>
														</div>
													</div>
													<div class="form-group">
														<label class="col-md-2 control-label">栏目关键词</label>
														<div class="col-md-8">
															<input type="text" class="form-control input-circle" placeholder="关键词之间用逗号隔开" name="keywords" value="{{$type->keywords}}" required>
														</div>
													</div>
													<div class="form-group">
														<label class="col-md-2 control-label">栏目表述</label>
														<div class="col-md-8">
															<textarea  rows="3" class="form-control input-circle" placeholder="" name="description" value="{{$type->description}}" required></textarea>
