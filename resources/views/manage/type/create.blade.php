											...
											{{ csrf_field() }}
												...
												<div class="form-body">
													<div class="form-group">
														...
														<div class="col-md-8">
															<select class="form-control" name="typeid" required>
																...
																<option value="{{$vo->id}}.{{$vo->path}}">{!! $nbsp[$k] !!}{{$vo->name}}</option>
																@endforeach
															</select>
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-md-8">
															<input type="text" class="form-control input-circle" placeholder="栏目名称" required="" name="name" required>
														</div>
													</div>
													<div class="form-group">
														<label class="col-md-2 control-label">英文名称</label>
														<div class="col-md-8">
															<input type="text" class="form-control input-circle" placeholder="英文名称" name="ename" required>
														</div>
													</div>		
													<div class="form-group">
														<label class="col-md-2 control-label">栏目关键词</label>
														<div class="col-md-8">
															<input type="text" class="form-control input-circle" placeholder="关键词之间用逗号隔开" name="keywords" required>
														</div>
													</div>
													<div class="form-group">
														<label class="col-md-2 control-label">栏目表述</label>
														<div class="col-md-8">
															<textarea  rows="3" class="form-control input-circle" placeholder="" name="description" required></textarea>
												...
												<div class="form-actions">
													<div class="row">
														<div class="col-md-offset-3 col-md-9">
															<button type="submit" class="btn btn-circle blue">提交数据</button>
															<button type="reset" class="btn btn-circle default">重置</button>
														</div>
													</div>
												</div>
											</form>
