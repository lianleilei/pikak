		...
		<div class="page-content-wrapper">
			<div class="page-content">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="btn-group">
							<a href="/manage/video/add" class="btn green">
					...
					<div class="col-md-6">
						...
						<form action="/manage/video" method="get">
									...
									<table class="table table-striped table-bordered table-hover">
										...
										<tbody>
											...
											<tr class="odd gradeX" id="tr_{{$vo->id}}">
												...
												<td>{{$vo->url}}</td>
		                                		<td>
					                                <a href="/manage/video/edit/{{$vo->id}}" class="btn default btn-xs purple">
														<i class="fa fa-edit"></i> 修改 </a>
				                                	<a href="javascript:;" class="btn default btn-xs black" onclick="delete_video('{{$vo->id}}')">
...
function delete_video(id){    
    confirm_ = confirm('此操作将删除此视频！你确定吗？');
    if(confirm_){
        $.ajax({
            type:"get",
            url:'/manage/video/del/'+id,
