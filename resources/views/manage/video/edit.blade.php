								...
								<div class="tab-pane active" id="tab_0">
									<div class="portlet box green">
										...
										<div class="portlet-body form">
											<!-- BEGIN FORM-->
											<form action="/manage/video/store" class="form-horizontal" method="post" enctype="multipart/form-data">
											{{ csrf_field() }}
												...
												<div class="form-body">
													...
													<div class="form-group">
														<label class="col-md-2 control-label">视频URL</label>
														<div class="col-md-8">
															<input type="text" class="form-control input-circle" placeholder="完整的视频链接" name="url" value="{{$data->url}}" required>
														</div>
													</div>
													<div class="form-group">
														<label class="col-md-2 control-label">封面图</label>
														<div class="col-md-8">
															<input type="file" class="form-control" name="thumb"> <span class="help-block m-b-none">请选择图片，如不做修改请略过 图片尺寸： 660*440</span>
														</div>
