											...
											{{ csrf_field() }}
												...
												<div class="form-body">
													...
													<div class="form-group">
														...
														<div class="col-md-8">
															<input type="text" class="form-control input-circle" placeholder="完整的视频链接" name="url" required>
														</div>
													</div>
													<div class="form-group">
														<label class="col-md-2 control-label">封面图</label>
														<div class="col-md-8">
															<input type="file" class="form-control" name="thumb" required> <span class="help-block m-b-none">请选择图片，图片尺寸： 660*440</span>
														</div>
													</div>
												</div>
