		...
		<div class="page-content-wrapper">
			<div class="page-content">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="btn-group">
							<a href="/manage/product/add" class="btn green">
									...
									<table class="table table-striped table-bordered table-hover">
										...
										<tbody>
											...
											<tr class="odd gradeX" id="tr_{{$vo->id}}">
												<td>{{$vo->id}}</td>
												<td>{{$vo->title}}</td>
												<td><img src="{{$vo->thumb}}" width="130"/></td>
												<td>{{$data['tname'][$key]}}</td>
												@if($vo->display == 0)
													<td><a href="/manage/product/send/{{$vo->id}}" class="btn default btn-xs red">
														<i class="fa fa-share"></i> 显示 </a>
													</td>
												@else
												<td>已显示</td>
												@endif
				                                ...
				                                <td>
					                                <a href="/manage/product/edit/{{$vo->id}}" class="btn default btn-xs purple">
														<i class="fa fa-edit"></i> 修改 </a>
				                                	<a href="javascript:;" class="btn default btn-xs black" onclick="delete_pro('{{$vo->id}}')">
