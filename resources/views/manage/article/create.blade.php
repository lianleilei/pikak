											...
											{{ csrf_field() }}
												...
												<div class="form-body">
													<div class="form-group">
														...
														<div class="col-md-8">
															<select class="form-control input-circle" name="typeid" required>
																<option>请选择分类</option>
													...
													<div class="form-group">
														...
														<div class="col-md-8">
															<input type="text" class="form-control input-circle" placeholder="20字以内" name="title" required>
														</div>
													</div>
													<div class="form-group">
														<label class="col-md-2 control-label">关键词</label>
														<div class="col-md-8">
															<input type="text" class="form-control input-circle" placeholder="多个关键词之间用空格或者“,”隔开" name="keywords" required>
														</div>
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														...
														<div class="col-md-8">
															<input type="file" class="form-control" name="thumb" required> <span class="help-block m-b-none">请选择图片，图片尺寸： 750*402</span>
														</div>
													</div>
												</div>
