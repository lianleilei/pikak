								...
								<div class="tab-pane active" id="tab_0">
									<div class="portlet box green">
										...
										<div class="portlet-body form">
											<!-- BEGIN FORM-->
											<form action="/manage/website/store" class="form-horizontal" method="post">
											{{ csrf_field() }}
												<div class="form-body">
													<div class="form-group">
														<label class="col-md-2 control-label">网站标题</label>
														<div class="col-md-8">
															<input type="text" class="form-control input-circle" name="title" required value="{{$web->title}}">
														</div>
													</div>
													<div class="form-group">
														<label class="col-md-2 control-label">关键词</label>
														<div class="col-md-8">
															<input type="text" class="form-control input-circle" placeholder="多个关键词之间用空格或者“,”隔开" name="keywords" required value="{{$web->keywords}}">
														</div>
													</div>
													<div class="form-group">
														<label class="col-md-2 control-label">网站描述</label>
														<div class="col-md-8">
															<textarea  rows="3" class="form-control input-circle" placeholder="" name="description" required>{{$web->description}}</textarea>
